...
# ffmpeg -f x11grab -s 1920x1080 -r 25 -i :0.0+1366,0 -t 00:00:10 /home/$USER/Desktop/ffmpeg_4screen_record/screen_0.mp4
# /home/$USER/Desktop/ffmpeg_4screen_record
...
do	
	...
	#ARCHIVE_TIME=`date +%F+%T | nawk '{gsub(/:/,"-")};1' | nawk '{gsub(/+/,"-")};1'`
	#cd /home/$USER/Desktop/cloud_storage/ && zip -r /home/$USER/Desktop/cloud_storage/archive_$ARCHIVE_TIME.zip archive  && rm -r /home/$USER/Desktop/cloud_storage/archive && cd /home/$USER/Desktop/ffmpeg_4screen_record
	...
	mv /home/$USER/Desktop/ffmpeg_4screen_record/screen_*.mp4 /home/$USER/Desktop/ffmpeg_4screen_record/archive/
	sleep 1
